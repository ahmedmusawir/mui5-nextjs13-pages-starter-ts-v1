...
const ReactMultiSlider = () => {
  return (
    <Layout>
      <Head>
        <title>Next Starter ReactMultiSlider</title>
        <meta name="description" content="This is the demo ReactMultiSlider" />
      </Head>
      <Container maxWidth="lg" sx={{ mt: 15, mb: 10 }}>
        <Box sx={{ px: { xs: 1, sm: 7 } }}>
          <h1 className="">
            This is the ReactMultiSlider Template for resue...
          </h1>
...
export default ReactMultiSlider;
